...
class WebSocketServer(QThread):
    ...
    async def run_server(self):
        ...
        if self.use_ssl:
            ...
            ssl_context.load_cert_chain('cert.pem', 'key.pem')  # Kendi sertifikalarınızı ekleyin
...
class ServerGUI(QMainWindow):
    ...
    def setup_ui(self):
        self.setWindowTitle("Romotica Sunucu v8.0 (Port 80/443 Desteği)")
        layout = QVBoxLayout()
        ...
        self.port_combo.addItems(["80 (HTTP)", "443 (HTTPS)"])
